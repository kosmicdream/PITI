...
NUM_GPUS=1
MODEL_FLAGS="--learn_sigma True --model_path /content/drive/MyDrive/checkpoints/PITI_sketch/base_edge.pt --sr_model_path /content/drive/MyDrive/checkpoints/PITI_sketch/upsample_edge.pt"
SAMPLE_FLAGS="--num_samples 5000 --sample_c 1.3 --batch_size 50"
DATASET_FLAGS="--data_dir image_path.txt --val_data_dir ./dataset/COCOSTUFF_val.txt --mode coco-edge"
